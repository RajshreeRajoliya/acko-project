  ...
  return (
    <div>
        ...
        fontSize="13px" >
            ...
            <Text> Bike Insurance</Text>
        </Box>
        <Box Align={"center"} mt="60px" fontSize="22px" fontWeight={"700"}>
            <Text>Buy/renew bike insurance online in India</Text>
            <Text>What is bike insurance?</Text>
        </Box>

        <Box mt="13px" ml="100px" fontSize="14px" fontWeight={"400"} color="gray.600"
        
        >
            <p mt="14px" letter-spacing="10px"  >Bike insurance refers to an insurance policy that covers various car-related risks. You need to pay an insurance premium to purchase a car insurance policy from an 
...
<Text>At ACKO, we have curated different bike insurance plans to suit your unique needs. Whether you want the basic Third-party Insurance Policy or Bumper-to-Bumper Bike 
